      ...
      <header className="flex items-center justify-between px-4 py-3 border-b border-slate-200 dark:border-slate-700 flex-shrink-0">
        ...
        <div className="flex-1 flex justify-center">
            <div className="flex items-center space-x-2">
                <ExtractIcon className="w-5 h-5 text-violet-500 dark:text-violet-400" />
                <h1 className="text-md font-bold text-slate-900 dark:text-slate-200">Extract from Catalog</h1>
            </div>
        </div>

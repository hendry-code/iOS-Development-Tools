    ...
    return (
        <div className="flex flex-col min-h-screen md:h-screen bg-slate-900 text-slate-100 font-sans">
            ...
            <div className="flex-1 flex flex-col md:flex-row md:overflow-hidden">
                ...
                {/* Main Content / Output */}
                <div className="w-full md:flex-1 min-h-[500px] md:min-h-0 md:h-full overflow-hidden bg-slate-950 p-6 flex flex-col border-t md:border-t-0 border-slate-800">

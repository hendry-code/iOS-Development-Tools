...
export type ViewMode = 'dashboard' | 'combine' | 'extract' | 'properties' | 'editor' | 'renamer' | 'merge' | 'wordcount' | 'analyser' | 'json-converter' | 'xml-converter' | 'json-formatter' | 'json-to-swift' | 'duplicate-finder' | 'script-runner';

...
export type ViewMode = 'dashboard' | 'combine' | 'extract' | 'properties' | 'editor' | 'renamer' | 'merge' | 'merge-catalogs' | 'wordcount' | 'analyser' | 'json-converter' | 'xml-converter' | 'json-formatter' | 'json-to-swift' | 'duplicate-finder' | 'script-runner' | 'mock-data' | 'app-icon-generator' | 'color-converter';
